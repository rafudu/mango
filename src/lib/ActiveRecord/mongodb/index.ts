import {Collection, Db, Document, Filter, FindOptions, OptionalId} from 'mongodb'
const Boom = require('@hapi/boom');
import { ObjectId } from 'mongodb';

type Record = OptionalId<Document> | null; 

export const connect = (db: Db , _collection: string) => {
    ...
    return class ActiveRecord {
        ...
        static async findOne(query: Filter<Document>, options: FindOptions<Document> = {}) {
